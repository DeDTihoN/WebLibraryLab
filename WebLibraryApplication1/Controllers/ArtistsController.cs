...
namespace WebLibraryApplication1.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> AlbumList(int? id)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Country")] Artist artist)
        {
            if (ModelState.IsValid)
            {
                artist.DateOfAdding = DateTime.Today; // Встановлюємо сьогоднішню дату
                _context.Add(artist);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,DateOfAdding,Country")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
